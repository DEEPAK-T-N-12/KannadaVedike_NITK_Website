const url = ['CaozAjMIEnj','Caod7lTobYV','Camic_dJE2o','Cad79yHpKF0','CZ2BfDEo0RY','CZYtLpRoLz-','CZGmwOEgrAM','CY1jdhro9SZ']
var count = 1;
function showInstaFeed(num){
    str = '';
    for (var postCount = 1; postCount < num && postCount < url.length; postCount++) {
        str+=`
            <div class="ld">
                <div class="item" loading ="lazy" >
                    <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/${url[postCount]}/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="12" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                        <div style="padding:16px;">
                        <a href="https://www.instagram.com/p/${url[postCount]}/?utm_source=ig_embed&amp;utm_campaign=loading" style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank">
...
// instaFeedSection starts here
// instaFeedSection ends here
...
footer.innerHTML = `
                    ...
                    <div id="lstFooter" class="flex notranslate">
